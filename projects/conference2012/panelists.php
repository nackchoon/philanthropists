...
<head>
	...
	<?php  
	    ...
	    $current_page = "conference_panelists";  
	...
	<div class="content">
		...
		<div class="project-text">
				...
				<div class="textpage">
					...
					<h3>The Philanthropic Conference Panelists</h3>
					
					<a name="snp"><h4>Strategic Non-Profit (전략적 비영리와 전략적 기부)</h4></a>
					<p>WEGENERATION 대표 문성현님</p>
					<p>UN MDGs 특별 대표 김정훈님</p>
					<p> </p>
					
					<br />

					<a name="mf"><h4>Microfinance (마이크로금융)</h4></a>
					...
					<a name="msd"><h4>Media in Social Development (사회발전과 언론)</h4></a>
					...
					<a name="sd"><h4>Social Design (사회디자인)</h4></a>
					...
					<a name="npc"><h4>Non-Profit Consulting (비영리 컨설팅)</h4></a>
					<p>전략적 사고를 바탕으로 미래적 가치를 추구하여 상업적 이익보다는 사회적 가치 창출을 목표로 하는 전문적인 컨설팅업무를 이른다.</p>
					
					<br />

					<a name="sns"><h4>SNS (소셜네트워크서비스)</h4></a>
