	...
	<ul class="dropdown">
		...
		<li class="root-item parent"><a <?php if ($current_page == "conference") { ?>class ="active"<?php } ?> href="/projects/conference/index.php">Conference</a>
			...
			<ul>
				...
				<!-- <li><a <?php if ($current_page == "conference_panelists") { ?>class="active"<?php } ?> href="/projects/conference/panelists.php#content">Panelists</a></li> -->
		...
		<!--
		<li class="root-item parent"><a <?php if ($current_page == "gallery") { ?>class="active"<?php } ?> href="/media/gallery.php">Media</a>

			<ul>

				<li class="first"><a <?php if ($current_page == "gallery") { ?>class="active"<?php } ?> href="/media/gallery.php">Gallery</a></li>

				<li class="last"><a <?php if ($current_page == "news") { ?>class="active"<?php } ?> href="/media/press.php">News Press</a></li>
